                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
                    <div className="col-span-full hidden lg:col-span-1 lg:block">
                        <a className="flex-none text-xl font-semibold dark:text-white" href="#"
                           aria-label="Brand">Next App</a>
                        <p className="mt-3 text-xs sm:text-sm text-gray-600 dark:text-neutral-400">© 2024 admol.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-3 grid space-y-3 text-sm">
                            ...
                            <p><a
                                className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200"
                                href="#">Careers</a> <span className="inline text-blue-600 dark:text-blue-500">— We're hiring</span>
                            </p>
                            <p><a
                                className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200"
                                href="#">Customers</a></p>
                    ...
                    <div>
                        ...
                        <div className="mt-3 grid space-y-3 text-sm">
                            ...
                            <p><a
                                className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200"
                                href="#">GitHub</a> <span
                                className="inline text-blue-600 dark:text-blue-500">— New</span></p>
                        </div>
                    ...
                    <div className="sm:flex sm:justify-between sm:items-center">
                        <div className="flex items-center gap-x-3">
                            ...
                            <div className="space-x-4 text-sm ms-4">
                                <a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200"
                                   href="/zh">简体中文</a>
                                <a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200"
                                   href="/us">United States</a>
                                <a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200"
                                   href="/in">India</a>
                                <a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200"
                                   href="/ph">Philippines</a>
                                <a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200"
                                   href="/th">Thailand</a>
                                <a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200"
                                   href="/my">Malaysia</a>
                        ...
                        <div className="flex justify-between items-center">
                            <div className="mt-3 sm:hidden">
                                ...
                                <p className="mt-1 text-xs sm:text-sm text-gray-600 dark:text-neutral-400">© 2022
                                    Preline.</p>
                            </div>
