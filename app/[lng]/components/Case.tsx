            ...
            <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
                    ...
                    <p className="mt-1 text-gray-600 dark:text-neutral-400">
                        10,000+ users have created profile pages
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div
                        ...
                        <div className="mt-3 space-x-1">
                            <a className="inline-flex justify-center items-center size-8 text-sm font-semibold rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:border-neutral-700 dark:hover:bg-neutral-700"
                               href="#">
                    ...
                    <a className="col-span-full lg:col-span-1 group flex flex-col justify-center text-center rounded-xl p-4 md:p-6 border border-dashed border-gray-200 hover:shadow-sm dark:border-neutral-700"
                       href="#">
                        <h3 className="text-lg text-gray-800 dark:text-neutral-200">
                            Want to see who is using it?
                        </h3>
                        <div>
                        <span
